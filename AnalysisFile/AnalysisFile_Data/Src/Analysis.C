...
//
 ...
 //       if(isData){
            ...
            if(!ifExistHLT_Ele32_WPTight_Gsf_L1DoubleEG) RHLT_Ele32_WPTight_Gsf_L1DoubleEG = false;
/*            if(SInputYear.find("SingleMuon_Run2016",0) != string::npos){
                ...
                if(RHLT_Ele25_eta2p1_WPTight_Gsf || RHLT_Ele27_eta2p1_WPTight_Gsf)     passHLTtrigger = false;
            ...
            if(SInputYear.find("SingleMuon_Run2016",0) != string::npos){
                if(RHLT_IsoMu24 || RHLT_IsoTkMu24)  passHLTtrigger = true;
            }else if(SInputYear.find("SingleElectron_Run2016",0) != string::npos){
                if(RHLT_IsoMu24 || RHLT_IsoTkMu24)  passHLTtrigger = false;
                if(RHLT_Ele27_eta2p1_WPTight_Gsf)     passHLTtrigger = true;
            }else if(SInputYear.find("SingleMuon_Run2017",0) != string::npos){
                if(RHLT_IsoMu27)                                       passHLTtrigger = true;
            }else if(SInputYear.find("SingleElectron_Run2017",0) != string::npos){
                if(RHLT_IsoMu27)                                       passHLTtrigger = false;
                if(RHLT_Ele32_WPTight_Gsf_L1DoubleEG)                  passHLTtrigger = true;
            }else if(SInputYear.find("SingleMuon_Run2018",0) != string::npos){
                if(RHLT_IsoMu24)                                       passHLTtrigger = true;
            }else if(SInputYear.find("EGamma_Run2018",0) != string::npos){
                if(RHLT_IsoMu24)                                       passHLTtrigger = false;
                if(RHLT_Ele32_WPTight_Gsf)                  passHLTtrigger = true;
            }else{
                cout<<"ERROR MESSAGE : From HLT Trigger part : should not see this message~"<<endl;
            }
