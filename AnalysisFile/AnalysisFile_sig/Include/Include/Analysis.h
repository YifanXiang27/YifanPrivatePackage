...
class Analysis{
    public:
        ...
        Float_t        RLHEReweightingWeight[36];

        Float_t        RMET_pt;
        Float_t        RMET_phi;

        Float_t        RMET_MetUnclustEnUpDeltaX;
        Float_t        RMET_MetUnclustEnUpDeltaY;
        ...
        Float_t        RL1PreFiringWeight_Nom;
        Float_t        RL1PreFiringWeight_Up;
        Float_t        RL1PreFiringWeight_Dn;
        ...
        UInt_t         RnLHEPdfWeight;
        Float_t        RLHEPdfWeight[1000];
        ...
        Float_t        RGenJet_pt[500];

        Float_t        RfixedGridRhoFastjetAll;
...
//        TH2D *Elec_Eff_ttH_tight;
        ...
        TH1D *P_Ak4Jet_Reso_Scale_Central;
        TH1D *P_Ak4Jet_Reso_Scale_up;
        TH1D *P_Ak4Jet_Reso_Scale_down;

        TH2D *P_Ak4Jet_Reso_Scale_vari0;
        TH2D *P_Ak4Jet_Reso_Scale_vari1;
        TH2D *P_Ak4Jet_Reso_Scale_vari2;
        TH2D *P_Ak4Jet_Reso_Scale_vari3;
...
/*
    if(if2016APV){
        TFile *file_Muon_Eff_ID = new TFile("./Include/ttHSF/MuonSFs/egammaEffi2016APV_EGM2D.root");
        Muon_Eff_LooseID = (TH2D *)file_Muon_Eff_ID->Get("EGamma_SF2D");
        ...
        TFile *file_Muon_Eff_ID = new TFile("./Include/ttHSF/MuonSFs/egammaEffi2016_EGM2D.root");
        Muon_Eff_LooseID = (TH2D *)file_Muon_Eff_ID->Get("EGamma_SF2D");
        ...
        TFile *file_Muon_Eff_ID = new TFile("./Include/ttHSF/MuonSFs/egammaEffi2017_EGM2D.root");
        Muon_Eff_LooseID = (TH2D *)file_Muon_Eff_ID->Get("EGamma_SF2D");
        ...
        TFile *file_Muon_Eff_ID = new TFile("./Include/ttHSF/MuonSFs/egammaEffi2018_EGM2D.root");
        Muon_Eff_LooseID = (TH2D *)file_Muon_Eff_ID->Get("EGamma_SF2D");
    ...
    TFile *file_JetCorrection[11];
    if(if2016APV){
        file_JetCorrection[0] = new TFile("./Include/Corrections/JetCorrection_Absolute2016APV.root");
        file_JetCorrection[1] = new TFile("./Include/Corrections/JetCorrection_Absolute_20162016APV.root");
        file_JetCorrection[2] = new TFile("./Include/Corrections/JetCorrection_BBEC12016APV.root");
        file_JetCorrection[3] = new TFile("./Include/Corrections/JetCorrection_BBEC1_20162016APV.root");
        file_JetCorrection[4] = new TFile("./Include/Corrections/JetCorrection_EC22016APV.root");
        file_JetCorrection[5] = new TFile("./Include/Corrections/JetCorrection_EC2_20162016APV.root");
        file_JetCorrection[6] = new TFile("./Include/Corrections/JetCorrection_FlavorQCD2016APV.root");
        file_JetCorrection[7] = new TFile("./Include/Corrections/JetCorrection_HF2016APV.root");
        file_JetCorrection[8] = new TFile("./Include/Corrections/JetCorrection_HF_20162016APV.root");
        file_JetCorrection[9] = new TFile("./Include/Corrections/JetCorrection_RelativeBal2016APV.root");
        file_JetCorrection[10] = new TFile("./Include/Corrections/JetCorrection_RelativeSample_20162016APV.root");
    }else if(if2016){
        file_JetCorrection[0] = new TFile("./Include/Corrections/JetCorrection_Absolute2016.root");
        file_JetCorrection[1] = new TFile("./Include/Corrections/JetCorrection_Absolute_20162016.root");
        file_JetCorrection[2] = new TFile("./Include/Corrections/JetCorrection_BBEC12016.root");
        file_JetCorrection[3] = new TFile("./Include/Corrections/JetCorrection_BBEC1_20162016.root");
        file_JetCorrection[4] = new TFile("./Include/Corrections/JetCorrection_EC22016.root");
        file_JetCorrection[5] = new TFile("./Include/Corrections/JetCorrection_EC2_20162016.root");
        file_JetCorrection[6] = new TFile("./Include/Corrections/JetCorrection_FlavorQCD2016.root");
        file_JetCorrection[7] = new TFile("./Include/Corrections/JetCorrection_HF2016.root");
        file_JetCorrection[8] = new TFile("./Include/Corrections/JetCorrection_HF_20162016.root");
        file_JetCorrection[9] = new TFile("./Include/Corrections/JetCorrection_RelativeBal2016.root");
        file_JetCorrection[10] = new TFile("./Include/Corrections/JetCorrection_RelativeSample_20162016.root");
    }else if(if2017){
        file_JetCorrection[0] = new TFile("./Include/Corrections/JetCorrection_Absolute2017.root");
        file_JetCorrection[1] = new TFile("./Include/Corrections/JetCorrection_Absolute_20172017.root");
        file_JetCorrection[2] = new TFile("./Include/Corrections/JetCorrection_BBEC12017.root");
        file_JetCorrection[3] = new TFile("./Include/Corrections/JetCorrection_BBEC1_20172017.root");
        file_JetCorrection[4] = new TFile("./Include/Corrections/JetCorrection_EC22017.root");
        file_JetCorrection[5] = new TFile("./Include/Corrections/JetCorrection_EC2_20172017.root");
        file_JetCorrection[6] = new TFile("./Include/Corrections/JetCorrection_FlavorQCD2017.root");
        file_JetCorrection[7] = new TFile("./Include/Corrections/JetCorrection_HF2017.root");
        file_JetCorrection[8] = new TFile("./Include/Corrections/JetCorrection_HF_20172017.root");
        file_JetCorrection[9] = new TFile("./Include/Corrections/JetCorrection_RelativeBal2017.root");
        file_JetCorrection[10] = new TFile("./Include/Corrections/JetCorrection_RelativeSample_20172017.root");
    }else if(if2018){
        file_JetCorrection[0] = new TFile("./Include/Corrections/JetCorrection_Absolute2018.root");
        file_JetCorrection[1] = new TFile("./Include/Corrections/JetCorrection_Absolute_20182018.root");
        file_JetCorrection[2] = new TFile("./Include/Corrections/JetCorrection_BBEC12018.root");
        file_JetCorrection[3] = new TFile("./Include/Corrections/JetCorrection_BBEC1_20182018.root");
        file_JetCorrection[4] = new TFile("./Include/Corrections/JetCorrection_EC22018.root");
        file_JetCorrection[5] = new TFile("./Include/Corrections/JetCorrection_EC2_20182018.root");
        file_JetCorrection[6] = new TFile("./Include/Corrections/JetCorrection_FlavorQCD2018.root");
        file_JetCorrection[7] = new TFile("./Include/Corrections/JetCorrection_HF2018.root");
        file_JetCorrection[8] = new TFile("./Include/Corrections/JetCorrection_HF_20182018.root");
        file_JetCorrection[9] = new TFile("./Include/Corrections/JetCorrection_RelativeBal2018.root");
        file_JetCorrection[10] = new TFile("./Include/Corrections/JetCorrection_RelativeSample_20182018.root");
    }
    ...
    for(int kk = 0 ; kk < 11 ; kk ++){
        P_Ak4Jet_Scale[kk] = (TH2D *)file_JetCorrection[kk]->Get("Jet_Uncertainty_Scale_Eta_Pt");
    }
    P_Ak4Jet_Reso_Scale_Central = (TH1D *)file_JetCorrection[0]->Get("Jet_Uncertainty_Resolution_Scale_central");
    P_Ak4Jet_Reso_Scale_up = (TH1D *)file_JetCorrection[0]->Get("Jet_Uncertainty_Resolution_Scale_up");
    P_Ak4Jet_Reso_Scale_down = (TH1D *)file_JetCorrection[0]->Get("Jet_Uncertainty_Resolution_Scale_down");

    P_Ak4Jet_Reso_Scale_vari0 = (TH2D *)file_JetCorrection[0]->Get("Jet_Uncertainty_Resolution_Sigma_vari0");
    P_Ak4Jet_Reso_Scale_vari1 = (TH2D *)file_JetCorrection[0]->Get("Jet_Uncertainty_Resolution_Sigma_vari1");
    P_Ak4Jet_Reso_Scale_vari2 = (TH2D *)file_JetCorrection[0]->Get("Jet_Uncertainty_Resolution_Sigma_vari2");
    P_Ak4Jet_Reso_Scale_vari3 = (TH2D *)file_JetCorrection[0]->Get("Jet_Uncertainty_Resolution_Sigma_vari3");
...
//    }
    ...
    fChain->SetBranchAddress("LHEReweightingWeight",&RLHEReweightingWeight);
    ...
    fChain->SetBranchAddress("MET_phi",&RMET_phi);
    fChain->SetBranchAddress("MET_MetUnclustEnUpDeltaX",&RMET_MetUnclustEnUpDeltaX);
    fChain->SetBranchAddress("MET_MetUnclustEnUpDeltaY",&RMET_MetUnclustEnUpDeltaY);
    fChain->SetBranchAddress("PSWeight",&RPSWeight);
    fChain->SetBranchAddress("LHEScaleWeight",&RLHEScaleWeight);
    fChain->SetBranchAddress("L1PreFiringWeight_Nom",&RL1PreFiringWeight_Nom);
    fChain->SetBranchAddress("L1PreFiringWeight_Up",&RL1PreFiringWeight_Up);
    fChain->SetBranchAddress("L1PreFiringWeight_Dn",&RL1PreFiringWeight_Dn);
    if(!isData)
...
*/
    ...
    fChain->SetBranchAddress("nLHEPdfWeight",&RnLHEPdfWeight);
    fChain->SetBranchAddress("LHEPdfWeight",&RLHEPdfWeight);

    fChain->SetBranchAddress("fixedGridRhoFastjetAll",&RfixedGridRhoFastjetAll);
    ...
    if(!isData){
        ...
        fChain->SetBranchAddress("GenJet_pt",&RGenJet_pt);
    }
    TObject *br;
