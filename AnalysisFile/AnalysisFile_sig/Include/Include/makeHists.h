...
class makeHists{
    public:
        ...
        Float_t  total_C2Vreweight[37];

        Float_t  total_LHEPdfWeight[1000];
        Int_t    total_nLHEPdfWeight;
        ...
        TH1D *Plot_raw_lepton_HLTtotal;
        TH1D *Plot_raw_elec_HLTtotal;
        TH1D *Plot_raw_muon_HLTtotal;

        TH1D *Plot_lepton_HLTtotal;
        TH1D *Plot_elec_HLTtotal;
        TH1D *Plot_muon_HLTtotal;

        TH1D *Plot_lepton_HLTpass;
        TH1D *Plot_elec_HLTpass;
        TH1D *Plot_muon_HLTpass;

        TH1D *Plot_1lepm_lepton_HLTtotal;
        TH1D *Plot_1lepm_elec_HLTtotal;
        TH1D *Plot_1lepm_muon_HLTtotal;

        TH1D *Plot_1lepm_lepton_HLTpass;
        TH1D *Plot_1lepm_elec_HLTpass;
        TH1D *Plot_1lepm_muon_HLTpass;

        TH1D *Plot_1lepe_lepton_HLTtotal;
        TH1D *Plot_1lepe_elec_HLTtotal;
        TH1D *Plot_1lepe_muon_HLTtotal;

        TH1D *Plot_1lepe_lepton_HLTpass;
        TH1D *Plot_1lepe_elec_HLTpass;
        TH1D *Plot_1lepe_muon_HLTpass;
        ...
        TH1D *Plot_bcategory;
        TH2D *Plot_loosebtag_eff_eta_pt;
        TH2D *Plot_tightbtag_eff_eta_pt;
        TH2D *Plot_notagbtag_eff_eta_pt;
        TH2D *Plot_loosectag_eff_eta_pt;
        TH2D *Plot_tightctag_eff_eta_pt;
        TH2D *Plot_notagctag_eff_eta_pt;
        TH2D *Plot_looseltag_eff_eta_pt;
        TH2D *Plot_tightltag_eff_eta_pt;
        TH2D *Plot_notagltag_eff_eta_pt;
