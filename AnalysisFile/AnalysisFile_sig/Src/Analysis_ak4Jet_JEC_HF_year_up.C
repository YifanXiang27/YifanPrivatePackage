...
RFatJet_pt[jj] = RFatJet_pt[jj] * (1 + P_Ak4Jet_Scale[8]->GetBinContent(P_Ak4Jet_Scale[8]->FindBin(RFatJet_eta[jj],RFatJet_pt[jj])));
...
//            double Zjetscore = RFatJet_particleNet_ZvsQCD[jj];
        ...
        for(int jj = 0 ; jj < idx_CORR_MET ; jj++){
            ...
            Correction_dpx *= (1 - P_Ak4Jet_Scale[8]->GetBinContent(P_Ak4Jet_Scale[8]->FindBin(RJet_eta[CORR_idxlist_MET[jj]],RJet_pt[CORR_idxlist_MET[jj]])));
            Correction_dpy *= (1 - P_Ak4Jet_Scale[8]->GetBinContent(P_Ak4Jet_Scale[8]->FindBin(RJet_eta[CORR_idxlist_MET[jj]],RJet_pt[CORR_idxlist_MET[jj]])));
            Correction_METx -= Correction_dpx;
            Correction_METy -= Correction_dpy;
        }
...
RJet_pt[jj] = RJet_pt[jj] * (1 + P_Ak4Jet_Scale[8]->GetBinContent(P_Ak4Jet_Scale[8]->FindBin(RJet_eta[jj],RJet_pt[jj])));
            //RJet_pt[jj] = RJet_pt[jj] * (1 - P_Ak4Jet_Scale[8]->GetBinContent(P_Ak4Jet_Scale[8]->FindBin(RJet_eta[jj],RJet_pt[jj])));
