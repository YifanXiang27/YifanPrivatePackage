...
void makeHists::bookHists(const char* fName){
    ...
    totaltree->Branch("Pileup_nTrueInt",&total_Pileup_nTrueInt,"&Pileup_nTrueInt/F");
    ...
    totaltree->Branch("total_C2Vreweight",&total_C2Vreweight,"total_C2Vreweight[37]/F");
    ...
    totaltree->Branch("total_LHEPdfWeight",&total_LHEPdfWeight,"total_LHEPdfWeight[1000]/F");
    totaltree->Branch("total_nLHEPdfWeight",&total_nLHEPdfWeight,"total_nLHEPdfWeight/I");
    ...
    Plot_lepton_HLTtotal = new TH1D("Plot_lepton_HLTtotal","Plot_lepton_HLTtotal",100,0,1000);
    Plot_elec_HLTtotal = new TH1D("Plot_elec_HLTtotal","Plot_elec_HLTtotal",100,0,1000);
    Plot_muon_HLTtotal = new TH1D("Plot_muon_HLTtotal","Plot_muon_HLTtotal",100,0,1000);

    Plot_raw_lepton_HLTtotal = new TH1D("Plot_raw_lepton_HLTtotal","Plot_raw_lepton_HLTtotal",100,0,1000);
    Plot_raw_elec_HLTtotal = new TH1D("Plot_raw_elec_HLTtotal","Plot_raw_elec_HLTtotal",100,0,1000);
    Plot_raw_muon_HLTtotal = new TH1D("Plot_raw_muon_HLTtotal","Plot_raw_muon_HLTtotal",100,0,1000);

    Plot_lepton_HLTpass = new TH1D("Plot_lepton_HLTpass","Plot_lepton_HLTpass",100,0,1000);
    Plot_elec_HLTpass = new TH1D("Plot_elec_HLTpass","Plot_elec_HLTpass",100,0,1000);
    Plot_muon_HLTpass = new TH1D("Plot_muon_HLTpass","Plot_muon_HLTpass",100,0,1000);

    Plot_lepton_HLTtotal->Sumw2();
    Plot_elec_HLTtotal->Sumw2();
    Plot_muon_HLTtotal->Sumw2();

    Plot_raw_lepton_HLTtotal->Sumw2();
    Plot_raw_elec_HLTtotal->Sumw2();
    Plot_raw_muon_HLTtotal->Sumw2();
    
    Plot_lepton_HLTpass->Sumw2();
    Plot_elec_HLTpass->Sumw2();
    Plot_muon_HLTpass->Sumw2();

    Plot_1lepe_lepton_HLTtotal = new TH1D("Plot_1lepe_lepton_HLTtotal","Plot_1lepe_lepton_HLTtotal",100,0,1000);
    Plot_1lepe_elec_HLTtotal = new TH1D("Plot_1lepe_elec_HLTtotal","Plot_1lepe_elec_HLTtotal",100,0,1000);
    Plot_1lepe_muon_HLTtotal = new TH1D("Plot_1lepe_muon_HLTtotal","Plot_1lepe_muon_HLTtotal",100,0,1000);

    Plot_1lepe_lepton_HLTpass = new TH1D("Plot_1lepe_lepton_HLTpass","Plot_1lepe_lepton_HLTpass",100,0,1000);
    Plot_1lepe_elec_HLTpass = new TH1D("Plot_1lepe_elec_HLTpass","Plot_1lepe_elec_HLTpass",100,0,1000);
    Plot_1lepe_muon_HLTpass = new TH1D("Plot_1lepe_muon_HLTpass","Plot_1lepe_muon_HLTpass",100,0,1000);

    Plot_1lepe_lepton_HLTtotal->Sumw2();
    Plot_1lepe_elec_HLTtotal->Sumw2();
    Plot_1lepe_muon_HLTtotal->Sumw2();
    
    Plot_1lepe_lepton_HLTpass->Sumw2();
    Plot_1lepe_elec_HLTpass->Sumw2();
    Plot_1lepe_muon_HLTpass->Sumw2();
    
    Plot_1lepm_lepton_HLTtotal = new TH1D("Plot_1lepm_lepton_HLTtotal","Plot_1lepm_lepton_HLTtotal",100,0,1000);
    Plot_1lepm_elec_HLTtotal = new TH1D("Plot_1lepm_elec_HLTtotal","Plot_1lepm_elec_HLTtotal",100,0,1000);
    Plot_1lepm_muon_HLTtotal = new TH1D("Plot_1lepm_muon_HLTtotal","Plot_1lepm_muon_HLTtotal",100,0,1000);

    Plot_1lepm_lepton_HLTpass = new TH1D("Plot_1lepm_lepton_HLTpass","Plot_1lepm_lepton_HLTpass",100,0,1000);
    Plot_1lepm_elec_HLTpass = new TH1D("Plot_1lepm_elec_HLTpass","Plot_1lepm_elec_HLTpass",100,0,1000);
    Plot_1lepm_muon_HLTpass = new TH1D("Plot_1lepm_muon_HLTpass","Plot_1lepm_muon_HLTpass",100,0,1000);

    Plot_1lepm_lepton_HLTtotal->Sumw2();
    Plot_1lepm_elec_HLTtotal->Sumw2();
    Plot_1lepm_muon_HLTtotal->Sumw2();
    
    Plot_1lepm_lepton_HLTpass->Sumw2();
    Plot_1lepm_elec_HLTpass->Sumw2();
    Plot_1lepm_muon_HLTpass->Sumw2();
    ...
    Plot_loosebtag_eff_eta_pt = new TH2D("Plot_loosebtag_eff_eta_pt","Plot_loosebtag_eff_eta_pt",4,0,2.5,10,20,300);
    Plot_tightbtag_eff_eta_pt = new TH2D("Plot_tightbtag_eff_eta_pt","Plot_tightbtag_eff_eta_pt",4,0,2.5,10,20,300);
    Plot_notagbtag_eff_eta_pt = new TH2D("Plot_notagbtag_eff_eta_pt","Plot_notagbtag_eff_eta_pt",4,0,2.5,10,20,300);
    Plot_loosectag_eff_eta_pt = new TH2D("Plot_loosectag_eff_eta_pt","Plot_loosectag_eff_eta_pt",4,0,2.5,10,20,300);
    Plot_tightctag_eff_eta_pt = new TH2D("Plot_tightctag_eff_eta_pt","Plot_tightctag_eff_eta_pt",4,0,2.5,10,20,300);
    Plot_notagctag_eff_eta_pt = new TH2D("Plot_notagctag_eff_eta_pt","Plot_notagctag_eff_eta_pt",4,0,2.5,10,20,300);
    Plot_looseltag_eff_eta_pt = new TH2D("Plot_looseltag_eff_eta_pt","Plot_looseltag_eff_eta_pt",4,0,2.5,10,20,300);
    Plot_tightltag_eff_eta_pt = new TH2D("Plot_tightltag_eff_eta_pt","Plot_tightltag_eff_eta_pt",4,0,2.5,10,20,300);
    Plot_notagltag_eff_eta_pt = new TH2D("Plot_notagltag_eff_eta_pt","Plot_notagltag_eff_eta_pt",4,0,2.5,10,20,300);

    Plot_loosebtag_eff_eta_pt->Sumw2();
    Plot_tightbtag_eff_eta_pt->Sumw2();
    Plot_notagbtag_eff_eta_pt->Sumw2();
    Plot_loosectag_eff_eta_pt->Sumw2();
    Plot_tightctag_eff_eta_pt->Sumw2();
    Plot_notagctag_eff_eta_pt->Sumw2();
    Plot_looseltag_eff_eta_pt->Sumw2();
    Plot_tightltag_eff_eta_pt->Sumw2();
    Plot_notagltag_eff_eta_pt->Sumw2();
