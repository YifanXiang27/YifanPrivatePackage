...
//
    ...
    else if(InputYear == "VBSOSWWH2016")
        weight_xsec = 0.000409086;
    else if(InputYear == "VBSOSWWH2016APV")
        weight_xsec = 0.000475037;
    else if(InputYear == "VBSOSWWH2017")
        weight_xsec = 0.00101067;
    else if(InputYear == "VBSOSWWH2018")
        weight_xsec = 0.00145291;
    else if(InputYear == "VBSWWH2016")
        weight_xsec = 0.00025726;
    else if(InputYear == "VBSWWH2016APV")
        weight_xsec = 0.000295744;
    else if(InputYear == "VBSWWH2017")
        weight_xsec = 0.000629198;
    else if(InputYear == "VBSWWH2018")
        weight_xsec = 0.000904503;
    else if(InputYear == "VBSWZH2016")
        weight_xsec = 0.000260849;
    else if(InputYear == "VBSWZH2016APV")
        weight_xsec = 0.000302907;
    else if(InputYear == "VBSWZH2017")
        weight_xsec = 0.000644438;
    else if(InputYear == "VBSWZH2018")
        weight_xsec = 0.000926356;
    else if(InputYear == "VBSZZH2016")
        weight_xsec = 0.000183056;
    else if(InputYear == "VBSZZH2016APV")
        weight_xsec = 0.00021042;
    else if(InputYear == "VBSZZH2017")
        weight_xsec = 0.000452238;
    else if(InputYear == "VBSZZH2018")
        weight_xsec = 0.000643548;
	...
	//cout<<isData<<endl;
        ...
        if(isData){
            //((InputRoot.find("MuonEG",0)) != string::npos);
            if(SInputYear.find("SingleMuon_Run2016",0) != string::npos){
                if(RHLT_IsoMu22 || RHLT_IsoTkMu22 || RHLT_IsoMu24 || RHLT_IsoTkMu24)  passHLTtrigger = true;
            }else if(SInputYear.find("SingleElectron_Run2016",0) != string::npos){
                if(RHLT_Ele25_eta2p1_WPTight_Gsf || RHLT_Ele27_eta2p1_WPTight_Gsf)     passHLTtrigger = true;
            }else if(SInputYear.find("SingleMuon_Run2017",0) != string::npos){
                if(RHLT_IsoMu24 || RHLT_IsoMu27)                                       passHLTtrigger = true;
            }else if(SInputYear.find("SingleElectron_Run2017",0) != string::npos){
                if(RHLT_Ele35_WPTight_Gsf || RHLT_Ele32_WPTight_Gsf)                  passHLTtrigger = true;
            }else if(SInputYear.find("SingleMuon_Run2018",0) != string::npos){
                if(RHLT_IsoMu24 || RHLT_IsoMu27)                                       passHLTtrigger = true;
            }else if(SInputYear.find("EGamma_Run2018",0) != string::npos){
                if(RHLT_Ele35_WPTight_Gsf || RHLT_Ele32_WPTight_Gsf)                  passHLTtrigger = true;
            }else{
...
//                leptonsf = leptonsf * getElecRecoEffSFUL(TRlepton1.Eta(), TRlepton1.Pt(), leptonsf_year);
//                leptonsf = leptonsf * getElecPOGLooseSF(TRlepton1.Eta(), TRlepton1.Pt(), leptonsf_year);
//                leptonsf = leptonsf * getElecLooseSF(TRlepton1.Eta(), TRlepton1.Pt(), leptonsf_year);
//                leptonsf = leptonsf * getElecTightSF(TRlepton1.Eta(), TRlepton1.Pt(), leptonsf_year);
            }
            else if(abs(Idlep1) == 13){
                ...
                //leptonsf = leptonsf * getMuonLooseSF(TRlepton1.Eta(), TRlepton1.Pt(), leptonsf_year);
                //leptonsf = leptonsf * getMuonTightSF(TRlepton1.Eta(), TRlepton1.Pt(), leptonsf_year);
            }
        }
...
//            double Zjetscore = RFatJet_particleNet_ZvsQCD[jj];
        ...
        if(Idlep1 == -11 || Idlep1 == 11){
            ...
            if( RElectron_mvaTTHUL[Idxlep1] >= 1 )
                myhists->Plot_fatjettag_elecmvascore->Fill(0.999,weight);
            else if( RElectron_mvaTTHUL[Idxlep1] <= -1 )
                myhists->Plot_fatjettag_elecmvascore->Fill(-0.999,weight);
            else
                myhists->Plot_fatjettag_elecmvascore->Fill(RElectron_mvaTTHUL[Idxlep1],weight);
        }else{
            ...
            if( RMuon_mvaTTHUL[Idxlep1] >= 1 )
                myhists->Plot_fatjettag_muonmvascore->Fill(0.999,weight);
            else if( RMuon_mvaTTHUL[Idxlep1] <= -1 )
                myhists->Plot_fatjettag_muonmvascore->Fill(-0.999,weight);
            else
                myhists->Plot_fatjettag_muonmvascore->Fill(RMuon_mvaTTHUL[Idxlep1],weight);
        }
        ...
        for(int jj = 0 ; jj < RnJet ; jj ++){
            ...
            if(idx_bjetcandi<20){
                myhists->total_bjetpt[idx_bjetcandi] = RJet_pt[jj];
                myhists->total_bjeteta[idx_bjetcandi] = RJet_eta[jj];
                myhists->total_bjetphi[idx_bjetcandi] = RJet_phi[jj];
                myhists->total_bjetmass[idx_bjetcandi] = RJet_mass[jj];
        ...
        if(Idlep1 == 11 || Idlep1 == -11){
            ...
            if( RElectron_mvaTTHUL[Idxlep1] >= 1 )
                myhists->Plot_tightak4tag_elecmvascore->Fill(0.999,weight);
            else if( RElectron_mvaTTHUL[Idxlep1] <= -1 )
                myhists->Plot_tightak4tag_elecmvascore->Fill(-0.999,weight);
            else
                myhists->Plot_tightak4tag_elecmvascore->Fill(RElectron_mvaTTHUL[Idxlep1],weight);
        }else{
            if( RMuon_pt[Idxlep1] >= 1000 )
            ...
            if( RMuon_mvaTTHUL[Idxlep1] >= 1 )
                myhists->Plot_tightak4tag_muonmvascore->Fill(0.999,weight);
            else if( RMuon_mvaTTHUL[Idxlep1] <= -1 )
                myhists->Plot_tightak4tag_muonmvascore->Fill(-0.999,weight);
            else
                myhists->Plot_tightak4tag_muonmvascore->Fill(RMuon_mvaTTHUL[Idxlep1],weight);
        }
        ...
        if(Idlep1 == 11 || Idlep1 == -11){
            ...
            if( RElectron_mvaTTHUL[Idxlep1] >= 1 )
                myhists->Plot_VBStag_elecmvascore->Fill(0.999,weight);
            else if( RElectron_mvaTTHUL[Idxlep1] <= -1 )
                myhists->Plot_VBStag_elecmvascore->Fill(-0.999,weight);
            else
                myhists->Plot_VBStag_elecmvascore->Fill(RElectron_mvaTTHUL[Idxlep1],weight);
        }else{
            if( RMuon_pt[Idxlep1] >= 1000 )
            ...
            if( RMuon_mvaTTHUL[Idxlep1] >= 1 )
                myhists->Plot_VBStag_muonmvascore->Fill(0.999,weight);
            else if( RMuon_mvaTTHUL[Idxlep1] <= -1 )
                myhists->Plot_VBStag_muonmvascore->Fill(-0.999,weight);
            else
                myhists->Plot_VBStag_muonmvascore->Fill(RMuon_mvaTTHUL[Idxlep1],weight);
        }
        ...
        if( ((TRleadingvbsjet+TRsubleadvbsjet).M()) >= 1000 )
            myhists->Plot_VBStag_vbsMjj->Fill(999.5,weight);
