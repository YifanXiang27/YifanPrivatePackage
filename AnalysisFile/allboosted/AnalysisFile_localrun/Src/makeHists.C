...
void makeHists::bookHists(const char* fName){
    ...
    totaltree->Branch("total_bjethadronFlavour",&total_bjethadronFlavour,"total_bjethadronFlavour[20]/F");
    ...
    Plot_VBStag_vbsMjj = new TH1D("Plot_VBStag_vbsMjj","Plot_VBStag_vbsMjj",1000,0,1000);
