...
int main(int argc, char **argv){
    ...
    while(infile>>read){
        ...
        if(samplename.find("_NanoAODv9") == string::npos){
...
//            continue;
//        }
        int position = samplename.find("UL201");
        position -= 1;
        ...
        if(samplename.find("Run2016") != string::npos && samplename.find("HIPM") != string::npos){
        ...
        else if(samplename.find("Run2016") != string::npos){
        ...
        else if(samplename.find("Run2017") != string::npos){
        ...
        else if(samplename.find("Run2018") != string::npos){
