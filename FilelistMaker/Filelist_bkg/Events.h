...
// Tue Jan 17 12:59:43 2023 by ROOT version 6.09/03
// from TTree Events/Events
// found on file: output_100.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[172];   //[nGenPart]
   Float_t         GenPart_mass[172];   //[nGenPart]
   Float_t         GenPart_phi[172];   //[nGenPart]
   Float_t         GenPart_pt[172];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[172];   //[nGenPart]
   Int_t           GenPart_pdgId[172];   //[nGenPart]
   Int_t           GenPart_status[172];   //[nGenPart]
   Int_t           GenPart_statusFlags[172];   //[nGenPart]
   ...
   Int_t           Muon_fsrPhotonIdx[17];   //[nMuon]
   ...
   UChar_t         Muon_mvaLowPtId[17];   //[nMuon]
   ...
   UChar_t         Muon_cleanmask[17];   //[nMuon]
   ...
   Float_t         Muon_jetBTagDeepFlav[17];   //[nMuon]
   Float_t         Electron_jetBTagDeepFlav[9];   //[nElectron]
   Float_t         Muon_mvaTTHUL[17];   //[nMuon]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_100.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_100.root");
      }
