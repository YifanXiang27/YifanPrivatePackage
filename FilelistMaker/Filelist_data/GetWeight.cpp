...
int main(int argc, char **argv){
    ...
    while(infile>>read){
        ...
        outwritefilelist.open("List/Filelist_" + name + ".list",ios::app);
        string readlist;
        totalEventCount = 0;
        totalEventSumw = 0;
        totalEventSumw2 = 0;
        ...
        genEventSumw2 = 0;
        cout<<name<<endl;
        //SingleElectron_Run2016F-HIPM2016APV
        if(name == "SingleElectron_Run2016F-HIPM2016APV") cout<<name<<endl;
        while(infile_list>>readlist){
        //infile_list>>readlist;
        //{
            ...
            tree = (TTree *)Tfile->Get("Events");
            if(name == "SingleElectron_Run2016F-HIPM2016APV") cout<<C_readlist<<endl;

            if (tree == NULL) {
                cout<<(FilelistRoute + "/Filelist_" + name + ".list")<<endl;
                if(name == "SingleElectron_Run2016F2016APV")  cout<<"test"<<endl;
                outfile_Fail<<C_readlist<<endl;
                continue;
            }
...
/*            tree->SetBranchAddress("genEventCount",&genEventCount);
            ...
            for(int ii = 0 ; ii < Nentries ; ii ++){
                ...
                cout<<name<<"   "<<totalEventSumw<<"   "<<genEventSumw<<endl;
